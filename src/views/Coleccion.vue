      ...
      <aside class="md:col-span-1 bg-white p-6 shadow-md">
        ...
        <ul class="space-y-3 mb-8">
          <li v-for="cat in categories" :key="cat">
            <button @click="filters.category = cat" :class="[
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-wrap gap-2">
            <button v-for="size in sizes" :key="size" @click="filters.size = size" :class="[
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-wrap gap-2">
            <span v-for="color in colors" :key="color" @click="filters.color = color"
        ...
        <div>
          ...
          <input type="range" min="0" max="100000" v-model="filters.price" class="w-full accent-[#ff4d6d]" />
...
watch(
  ...
  () => {
    ...
    debounceTimeout = setTimeout(() => {
      ...
      fetchProducts()
    }, 500) // Espera 500 ms antes de hacer el llamado
  },
  { deep: true }
)
</script>